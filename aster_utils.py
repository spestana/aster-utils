...
def reproject_aster_l1t(aster_l1t_filepath, dst_crs = 'EPSG:4326'):

    dst_filepath =  aster_l1t_filepath.split(".")[0] + "_{dst_crs}.tif".format(dst_crs=dst_crs.replace(":","_"))
    
    # Reproject ASTER image to new CRS and save new file
    with rasterio.open(aster_l1t_filepath) as src:
